        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            ...
            <button
              ...
              className={`px-4 py-2.5 rounded-xl border flex items-center justify-center gap-2 text-[13px] font-bold transition-all ${showFilters ? 'bg-gray-100 border-gray-300 text-gray-900 shadow-inner' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'
                }`}
            >
              <Filter size={16} />
              Filter
